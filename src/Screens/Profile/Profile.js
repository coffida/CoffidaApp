...
class Profile extends Component {
  ...
  get_profile_data = async (GetProfileUserData) => {
    const response = await fetch('https://virtserver.swaggerhub.com/zedrem/CoffiDa/1.0.0/user/' + GetProfileUserData, {
      method: 'get',
      headers: {
  ...
  updateProfile(){
    ...
    return fetch("https://virtserver.swaggerhub.com/zedrem/CoffiDa/1.0.0/user/" + this.state.user_id_val, {
      method: 'patch',
      headers: {
        'Content-Type': 'application/json'
      },
